...
class TestQueryEndpoint:
    ...
    @pytest.mark.parametrize("query_text,expected_status,expected_detail", [
        ("", 422, "String should have at least 1 character"),  # Pydantic validation
        ("   ", 400, "Query text cannot be empty or whitespace only"),  # Custom validation
    ...
    def test_query_validation(self, test_client: TestClient, query_text: str, expected_status: int, expected_detail: str):
    ...
    def test_query_with_rag_system_error(self, mock_rag_system: MagicMock, test_client: TestClient):
    ...
    def test_query_with_unexpected_error(self, mock_rag_system: MagicMock, test_client: TestClient):
