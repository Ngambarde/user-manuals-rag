...
class TestSystemInfo:
    ...
    def test_system_info_with_rag_system_error(self, mock_rag_system: MagicMock, test_client: TestClient):
...
class TestIntegration:
    ...
    def test_full_request_flow(self, test_client: TestClient, test_config: Dict[str, Any]):
    ...
    @pytest.mark.integration
    def test_error_propagation(self, mock_rag_system: MagicMock, test_client: TestClient):
        ...
        mock_rag_system.get_rag_response.side_effect = RAGError("Query processing failed")
